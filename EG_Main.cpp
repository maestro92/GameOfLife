...
void ExplosionGenerator::initGUI()
{
    ...
    {
        EG_Utility::debug("Could not load character 'X'\n");
    }
...
*/
    ...
    m_GUIManager.setGOLModelListBoxMenuContent(m_GOLModelManager.getModels());
}
...
*/
    glEnable(GL_BLEND);
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    m_rm.renderText(Characters['c'].TextureID, 0, m_GUIManager.m_paletteRect);// SCREEN_WIDTH - 200, 0, 200, SCREEN_HEIGHT);
