...
#include "imported_animated_model.h"


ImportedAnimatedModel::ImportedAnimatedModel() : EG_Model(7)
{
    m_VAO = 0;
    ZERO_MEM(m_Buffers);
    m_NumBones = 0;
...
ImportedAnimatedModel::~ImportedAnimatedModel()
{
    clear();
}


bool ImportedAnimatedModel::loadModel(string filename)
{
    clear();
...
void ImportedAnimatedModel::transferDataToBuffer(vector<VertexBoneData>& vec, unsigned int bufferIndex, unsigned int location)
{
...
bool ImportedAnimatedModel::initFromAiScene(const aiScene* s, const string& Filename)
{
...
void ImportedAnimatedModel::initMesh(unsigned int MeshIndex, const aiMesh* m, const aiScene* s,
                                  vector<glm::vec3>& Positions,
                                  vector<glm::vec3>& Normals,
                                  vector<glm::vec3>& Tangents,
                                  vector<glm::vec3>& Colors,
...
void ImportedAnimatedModel::loadBones(unsigned int MeshIndex, const aiMesh* m, vector<VertexBoneData>& Bones)
{
...
void ImportedAnimatedModel::boneTransform(float timeInSeconds, vector<glm::mat4>& transforms)
{
...
void ImportedAnimatedModel::boneTransform(float timeInSeconds)
{
    glm::mat4 identity = glm::mat4(1.0f);
    float timeInTicks = timeInSeconds * m_TicksPerSecond;
    float animationTime = fmod(timeInTicks, m_AnimFrameDuration);
...
void ImportedAnimatedModel::readNodeHierarchy(float animationTime, const aiNode* node, const glm::mat4& parentTransform)
{
...
void ImportedAnimatedModel::boneTransformTranspose(float timeInSeconds, vector<glm::mat4>& transforms)
{
    glm::mat4 identity = glm::mat4(1.0f);
    float timeInTicks = timeInSeconds * m_TicksPerSecond;
    float animationTime = fmod(timeInTicks, m_AnimFrameDuration);
...
void ImportedAnimatedModel::readNodeHierarchyTranspose(float animationTime, const aiNode* node, const glm::mat4& parentTransform)
{
    string nodeName(node->mName.data);
    const aiAnimation* animation = m_Scene->mAnimations[0];
...
glm::mat4 ImportedAnimatedModel::computeInterpolatedScalingMatrix(float animationTime, const aiNodeAnim* nodeAnim)
{
...
glm::mat4 ImportedAnimatedModel::computeInterpolatedRotationMatrix(float animationTime, const aiNodeAnim* nodeAnim)
{
...
glm::mat4 ImportedAnimatedModel::computeInterpolatedPositionMatrix(float animationTime, const aiNodeAnim* nodeAnim)
{
...
unsigned int ImportedAnimatedModel::findPosition(float animationTime, const aiNodeAnim* nodeAnim)
{
...
unsigned int ImportedAnimatedModel::findRotation(float animationTime, const aiNodeAnim* nodeAnim)
{
...
unsigned int ImportedAnimatedModel::findScaling(float animationTime, const aiNodeAnim* nodeAnim)
{
...
float ImportedAnimatedModel::computeInterpolationTimeFactor(float animationTime, double t2, double t1)
{
...
glm::vec3 ImportedAnimatedModel::computeInterpolatedVector(float animationTime, aiVectorKey& k2, aiVectorKey& k1)
{
...
aiQuaternion ImportedAnimatedModel::computeInterpolatedQuaternion(float animationTime, aiQuatKey& k2, aiQuatKey& k1)
{
    float factor = computeInterpolationTimeFactor(animationTime, k2.mTime, k1.mTime);
    aiQuaternion out;
...
const aiNodeAnim* ImportedAnimatedModel::findNodeAnim(const aiAnimation* animation, const string nodeName)
{
...
/*
void ImportedAnimatedModel::render()
{
    EG_Model::render();
}
*/
